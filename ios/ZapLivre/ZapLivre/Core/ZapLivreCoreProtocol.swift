//
//  ZapLivreCoreProtocol.swift
//  ZapLivre
//
//  Created by ZapLivre Team
//  Copyright © 2026 ZapLivre. All rights reserved.
//
//  Abstraction over ZapLivreCore so that AppState (and tests) can depend on
//  a protocol instead of the concrete FFI-backed singleton.

import Foundation

/// Surface of ZapLivreCore consumed by AppState / app bootstrap logic.
/// Kept intentionally small - extend only when a consumer needs it.
protocol ZapLivreCoreProtocol: AnyObject {
...
extension ZapLivreCore: ZapLivreCoreProtocol {

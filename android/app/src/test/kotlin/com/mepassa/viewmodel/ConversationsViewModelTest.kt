...
import com.mepassa.ui.screens.conversations.ConversationsUiState
import com.mepassa.ui.screens.conversations.ConversationsViewModel
...
class ConversationsViewModelTest {
    ...
    fun `evento de mensagem recebida recarrega a lista`() {
        ...
        runVmTest { viewModel ->
            ...
            messageEvents.tryEmit(
                MePassaClientWrapper.MessageUiEvent.Received("msg-1", "peer-b")
            )
            runCurrent()
    ...
    fun `evento Typing nao recarrega a lista`() {
        ...
        runVmTest { viewModel ->
            ...
            coEvery { api.listConversations() } returns emptyList()
            messageEvents.tryEmit(
                MePassaClientWrapper.MessageUiEvent.Typing("peer-a", true)
            )
            runCurrent()

...
import uniffi.mepassa.FfiReaction

/**
 * Superfície mínima do cliente usada pelas telas de Conversas e Chat.
 *
 * Extraída de [MePassaClientWrapper] para permitir substituir o singleton
 * real por fakes/mocks em unit tests (via [ServiceLocator]).
 */
interface MePassaClientApi {
    ...
    val messageEvents: SharedFlow<MePassaClientWrapper.MessageUiEvent>
